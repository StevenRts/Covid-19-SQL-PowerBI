...
Queries used for Covid Project POWER BI
...
-- Some Other Queries I played around with
...
Select continent as continent, location, MAX(people_fully_vaccinated) as vaccinated
